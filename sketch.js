...
// Up arrow code
  ...
  if (keyWentUp(UP_ARROW) && player.velocityY > 0 ){
...
function spawnCar(){
  if(frameCount % Math.round(random(65,90)) === 0 ){
    var rand = Math.round(random(1,3));
    var rand2  = Math.round(random(0,3));
var car = createSprite(displayWidth,displayHeight - 200);
if(rand === 1){
  car.addImage(image1);
  car.scale = 0.55;
...
switch(rand2){
  //left
  case 0: car.x = -20
  car.y = Math.round(random(10,displayHeight-200))
  car.velocityX = 5;
 // car.addImage("image",image1);

  break;
  //right
  case 1: car.x = displayWidth + 20
  car.y = Math.round(random(10,displayHeight-200))
  car.velocityX = -5;
  //car.addImage("image",image1);
  ...
  break;
  //up
  case 2: car.x = Math.round(random(10,displayWidth - 200))
  car.y = 0
  car.velocityY = 5;
  break;
  //bottom
  case 3: car.x = Math.round(random(10,displayWidth - 200))
  car.y = displayHeight + 20;
  car.velocityY = -5;
  break;
  default: break;
}
